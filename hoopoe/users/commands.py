...
class UserCommands:
    ...
    def create_default_profile_image(self) -> bool:
        ...
        if not os.path.isfile(target_path+"/default.jpg"):
            image_in_assets = f"{BASE_DIR}/hoopoe/assets/{self.default_profile_img_path}/default.jpg"
            image_to_media = f"{BASE_DIR}/hoopoe/media/{self.default_profile_img_path}/default.jpg"
